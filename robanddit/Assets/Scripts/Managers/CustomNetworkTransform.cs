...
namespace Unity.Netcode.Components
{
    ...
    public class CustomNetworkTransform : NetworkBehaviour
    {
        ...
        /// </summary>
        public const float PositionThresholdDefault = 0.1f;
        ...
        /// <summary>
        /// ROBANDDIT Custom variable to reduce interpolation time to smoothen out TheHero 
        /// </summary>
...
//        }
        ...
        private void Awake()
        {
            ...
            m_PositionXInterpolator.MaximumInterpolationTime = maxInterpTime; // 0.005f;
            m_PositionYInterpolator.MaximumInterpolationTime = maxInterpTime; // 0.005f;
